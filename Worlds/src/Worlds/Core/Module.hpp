...
template <typename Base> class ModuleFactory {
  public:
    ...
    template <typename... Args> class Requires {
      public:
    ...
    template <typename T> class Registrar : public Base {
      ...
      protected:
        /**
         * Creates a new module singleton instance and registers into the module
         * registry map.
...
class Module : public ModuleFactory<Module> {
  public:
    /**
     * @brief Represents the stage where the module will be updated in the
     * engine.
     */
