...
std::string String::ConvertUtf8(const std::wstring_view &string) {
    return UTF8_TO_UTF16_CONVERTER.to_bytes(string.data(),
...
std::wstring String::ConvertUtf16(const std::string_view &string) {
    return UTF8_TO_UTF16_CONVERTER.from_bytes(string.data(),
                                              string.data() + string.length());
}
...
std::string_view String::Trim(std::string_view str,
...
std::string String::ReplaceAll(std::string str, std::string_view token,
                               std::string_view to) {
...
std::string String::ReplaceFirst(std::string str, std::string_view token,
                                 std::string_view to) {
